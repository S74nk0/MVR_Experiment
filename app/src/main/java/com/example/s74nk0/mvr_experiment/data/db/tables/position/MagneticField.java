 ...
 */
@Table(databaseName = DatabaseMain.NAME, tableName = MagneticField.NAME)
public class MagneticField extends CommonPositionBase {
    public static final String NAME = "MagneticField";
}
